...
MarkerClusterer.prototype.addToClosestCluster_ = function(marker) {
  ...
  if (clusterToAddTo && clusterToAddTo.isMarkerInClusterBounds(marker)) {
    clusterToAddTo.addMarker(marker);
      ...
      if(category=="1"){
        clusterToAddTo.group1Num++;
        console.log('1++');
      }else if (category=="2"){
        clusterToAddTo.group2Num++;
        console.log('2++');
      }else if (category=="3"){
        clusterToAddTo.group3Num++;
        console.log('3++');
      }else {
        clusterToAddTo.group4Num++;
        console.log('4++');
      }
...
MarkerClusterer.prototype.createClusters_ = function() {
  ...
  //loop through all markers to put into clusters
  for (var i = 0, marker; marker = this.markers_[i]; i++) {
...
ClusterIcon.prototype.onAdd = function() {
 ...
 if (this.visible_) {
  ...
  this.container_.setAttribute('class', 'pieContainer');
  this.container_.style.height = '30px';
  this.container_.style.width = '30px';

  this.background_.setAttribute('class', 'pieBackground');
  this.background_.style.height = diameter+'px';
  this.background_.style.width = diameter+'px';
  this.background_.style.borderRadius= radius+'px';
  this.background_.style.top = pos.y+ 'px';
  this.background_.style.left= pos.x+ 'px';
  this.background_.style.opacity= 0.3;

  this.container_.appendChild(this.background_);

  //loop thru proportion to draw slices
    ...
    {   
        ...
        if (degree>180){
            ...
            slice.style.top = pos.y+ 'px';
            slice.style.left= pos.x+ 'px';
            ...
            // pie.style.top = pos.y+ 'px';
            // pie.style.left= pos.x+ 'px';
...
ClusterIcon.prototype.onRemove = function() {
  if (this.parent_ && this.parent_.parentNode) {
    this.hide();
    this.parent_.parentNode.removeChild(this.parent_);
    this.div_ = null;
  }
};
...
/**
 * Set the # items in groups of the icon.
 *
 * @param {Object} sums The sums containing:
 *   'text': (string) The text to display in the icon.
 *   'index': (number) The style index of the icon.
 */
ClusterIcon.prototype.setGroupNums = function(g1, g2, g3, g4) {
  this.group1Num=g1;
  this.group2Num=g2;
  this.group3Num=g3;
  this.group4Num=g4;
...
ClusterIcon.prototype.createCss = function(pos) {
  ...
  style.push('border-radius:'+this.height_/2+'px;');
  style.push('box-shadow: -1px 1px 3px #ccc;');
  ...
  var txtSize = this.textSize_ ? this.textSize_ : 20;
