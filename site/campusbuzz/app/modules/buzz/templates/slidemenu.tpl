<div id="slideout">
  ...
  <div id="slideout_inner">
    ...
    <button class= "buzzCategory" id="buzzClubs" type="button" onclick="filterCategory(this)">Clubs</button>
    <button class= "buzzCategory" id="buzzHealth" type="button" onclick="filterCategory(this)">Well Being</button>
    <button class= "buzzCategory" id="buzzRecreation" type="button" onclick="filterCategory(this)">Leisure</button>
